...
Future<Uint8List> buildReceiptPdf(ReceiptPdfData r) async {
  // PlusJakartaSans includes the ₦ glyph; the PDF built-in fonts do not.
  final regular =
      ...
      build: (context) => pw.Column(
        ...
        children: [
          ...
          pw.Padding(
            ...
            child: pw.Column(
              children: [
                pw.Text('Thank you for banking with Rima MFB',
                    style: pw.TextStyle(font: bold, fontSize: 8.5, color: _green)),
                pw.SizedBox(height: 3),
                pw.Text(
                  'This receipt was generated by the RimaPay app. '
                  'Keep the Transaction ID for any enquiry.',
                  textAlign: pw.TextAlign.center,
...
Future<void> shareReceiptPdf(ReceiptPdfData r) async {
